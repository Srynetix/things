...
const PianoKeys = (props: Props) => {
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            const isMouseOverRect = (left: number, top: number, width: number, height: number): boolean => {
            ...
            const drawWhiteKey = (octave: number, idx: number) => {
                ...
                const finalColor = isMouseOverRect(xPos, 0, WHITE_KEY_WIDTH, WHITE_KEY_HEIGHT) ? HOVER_KEY_COLOR : color;
            ...
            const drawBlackKey = (octave: number, idx: number) => {
                ...
                const finalColor = isMouseOverRect(xPos, 0, BLACK_KEY_WIDTH, BLACK_KEY_HEIGHT) ? HOVER_KEY_COLOR : color;
