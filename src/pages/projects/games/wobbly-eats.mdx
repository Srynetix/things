...
<ProjectSummary
  urls={["https://github.com/Srynetix/wobbly-eats"]}
  screenshots={[
    require("./assets/wobbly-eats.png").default,
    require("./assets/wobbly-eats.gif").default,
  ]}
/>

## Summary

My 7th participation to the <ELink href="https://ldjam.com/events/ludum-dare/53">Ludum Dare game jam (edition #53)</ELink> compo.  
The theme was _Delivery_.

I was rated <ELink href="https://ldjam.com/events/ludum-dare/52/type-eat"><b>73rd</b> overall</ELink> (with a nice **9th** place in **Fun**).

Tools used:

- Godot Engine 4.0.2 with [sxgd](../../game-related/sxgd).
- Inkscape
- FL Studio
...
<ELink href="https://srynetix.github.io/wobbly-eats/">
  <b>🚀 Play it here!</b>
</ELink>
