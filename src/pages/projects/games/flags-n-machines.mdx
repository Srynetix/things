...
<ProjectSummary
  urls={["https://github.com/Srynetix/flags-n-machines"]}
  screenshots={[require("./assets/flags-n-machines.gif").default]}
/>
...
That's the game that made me start [Godot plugin projects](../../game-related/my-csharp-godot-plugins).
