...
<ProjectSummary
    ...
    screenshots={[require('./assets/time-lab.png').default, require('./assets/time-lab-preview.gif').default]}
/>
...
I was rated <ELink href="https://ldjam.com/events/ludum-dare/50/time-lab"><b>62th</b> overall</ELink>.  
...
<ELink href="https://srynetix.github.io/time-lab/"><b>🚀 Play it here!</b></ELink>
