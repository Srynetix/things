...
These plugins are **deprecated**, because I'm now only focusing on **GDScript** with Godot.  
But no worries, all of these plugins are included in my GDScript collection, [**sxgd**](../sxgd).
