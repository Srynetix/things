...
<ProjectSummary urls={["https://github.com/Srynetix/gdpm"]} />

## Summary

A command-line utility to handle <ELink href="https://godotengine.org/">Godot Engine</ELink> versions and Godot Engine projects, made in Rust.  
