...
Hello everyone, I'm **Denis BOURGE** (<ELink href="https://github.com/Srynetix">@Srynetix</ELink>), a 29 year old developer who fell in love with programming while I was in school.  
...
This site is also **open-source**, and you can access the code on <ELink href="https://github.com/Srynetix/things">GitHub</ELink>.
...
I also have some years of professional experience in the web development field, particularily with the <ELink href="https://www.djangoproject.com/">Django</ELink> framework (so with a **Python** backend), but in the end I'm more a _static-typed_ language fan.  
...
<ul>
  <li>
    <FaGithub /> GitHub -{" "}
    <ELink href="https://github.com/Srynetix">@Srynetix</ELink>
  </li>
  <li>
    <FaLinkedin /> LinkedIn -{" "}
    <ELink href="https://www.linkedin.com/in/denis-bourge-09676a110/">
      @Denis BOURGE
    </ELink>
  </li>
  <li>
    <FaSoundcloud /> Soundcloud -{" "}
    <ELink href="https://soundcloud.com/srynetix">@Srynetix</ELink>
  </li>
</ul>
