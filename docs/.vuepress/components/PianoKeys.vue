<template>
  <div class="container">
    <canvas ref="canvas" class="canvas" align="center">
    </canvas>
...
export default defineComponent({
  ...
  mounted() {
    const width = OCTAVE_WIDTH * this.octaves;
    const height = WHITE_KEY_HEIGHT;
    const asSolfege = this.solfegeNotation ?? false;
    const active: string[] = (() => {
    ...
    const drawWhiteKey = (octave: number, idx: number) => {
      ...
      const noteOctave = this.minOctave + octave;
